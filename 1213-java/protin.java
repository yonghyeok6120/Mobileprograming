...
public class protin extends AppCompatActivity {
    ...
    private void setInit() {
        ...
        mbtn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(protin.this, android.R.style.Theme_Material_Light_Dialog);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(protin.this, "리뷰가 추가되었습니다.", Toast.LENGTH_SHORT).show();
